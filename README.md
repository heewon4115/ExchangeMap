...
- `country_origin_add_toggle_click`: fires when users open or close the custom country form.
- `country_origin_option_add`: fires when users add a custom country/region and vote for it.
